...
GLfloat Rot_Light1_Count = 0.0f;
GLfloat Rot_Light2_Count = 0.0f;
GLfloat Rot_Light3_Count = 0.0f;
...
//        camZ = cos(glfwGetTime()) * radius;
        ...
        // point light 1
        pointLightPositions[0] = glm::vec3( -cos(Rot_Light1_Count)*2.5,  0.0f,  sin(Rot_Light1_Count)*2.5);
        ...
        // point light 2
        pointLightPositions[1] = glm::vec3( -cos(Rot_Light2_Count)*-2.5,  0.0f,  sin(Rot_Light2_Count)*2.5);
        ...
        // point light 3
        pointLightPositions[2] = glm::vec3(0.0f,  cos(Rot_Light3_Count),  sin(Rot_Light3_Count)*2.5);
        ...
        Program.setVec3("material.diffuse", 0.9f, 0.3f, 0.3f);
        Program.setVec3("material.specular", 1.0f, 0.5f, 0.5f);
        Program.setFloat("material.shininess", 16.0f);
        Program.setFloat("Alpha", 1.0);

        cubePositions[2] = glm::vec3( -cos(RotCount),  0.0f,  sin(RotCount));
        glm::mat4 model3 = glm::mat4(1.0f);
        model3 = glm::translate(model3, cubePositions[2]);
        model3 = glm::rotate(model3, glm::radians(RotCount*70), glm::vec3(0.5f, 1.0f, 0.0f));
        ...
        //~~~~~~~~~~~~~~~~~~ CUBE-2  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        Program.setVec3("material.ambient", 0.2f, 0.2f, 0.2f);
        Program.setVec3("material.diffuse", 0.3f, 0.9f, 0.3f);
        Program.setVec3("material.specular", 0.2f, 0.2f, 0.2f);
        Program.setFloat("material.shininess", 32.0f);
        Program.setFloat("Alpha", 1.0);

        cubePositions[1] = glm::vec3( sin(RotCount+1.6),  0.0f,  cos(RotCount+1.6));
        glm::mat4 model2 = glm::mat4(1.0f);
        model2 = glm::translate(model2, cubePositions[1]);
        model2 = glm::rotate(model2, glm::radians(RotCount*80), glm::vec3(0.5f, 1.0f, 0.7f));
        ...
        //~~~~~~~~~~~~~~~~~~ CUBE-1  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        Program.setVec3("material.ambient", 0.2f, 0.2f, 0.2f);
        Program.setVec3("material.diffuse", 0.9f, 0.9f, 0.9f);
        Program.setVec3("material.specular", 1.0f, 1.0f, 1.0f);
        Program.setFloat("material.shininess", 32.0f);
        Program.setFloat("Alpha", 0.5);
...
void processInput(GLFWwindow *window)
{
    ...
    if((glfwGetKey(window, GLFW_KEY_1) && glfwGetKey(window, GLFW_KEY_LEFT)) == GLFW_PRESS) {
        Rot_Light1_Count += 0.02;
    }
    if((glfwGetKey(window, GLFW_KEY_1) && glfwGetKey(window, GLFW_KEY_RIGHT)) == GLFW_PRESS) {
        Rot_Light1_Count -= 0.02;
    }

    if((glfwGetKey(window, GLFW_KEY_2) && glfwGetKey(window, GLFW_KEY_LEFT)) == GLFW_PRESS) {
        Rot_Light2_Count += 0.02;
    }
    if((glfwGetKey(window, GLFW_KEY_2) && glfwGetKey(window, GLFW_KEY_RIGHT)) == GLFW_PRESS) {
        Rot_Light2_Count -= 0.02;
    }

    if((glfwGetKey(window, GLFW_KEY_3) && glfwGetKey(window, GLFW_KEY_LEFT)) == GLFW_PRESS) {
        Rot_Light3_Count += 0.02;
    }
    if((glfwGetKey(window, GLFW_KEY_3) && glfwGetKey(window, GLFW_KEY_RIGHT)) == GLFW_PRESS) {
        Rot_Light3_Count -= 0.02;
    }
